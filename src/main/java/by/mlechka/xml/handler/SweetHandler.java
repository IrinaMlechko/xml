    ...
    public void characters(char[] ch, int start, int length) {
        ...
        if (currentXmlTag != null) {
            switch (currentXmlTag) {
                ...
                case ENERGY_UNIT -> current.getEnergy().setUnit(data.isBlank() ? data : "kcal");
                ...
                case AMOUNT ->
                        current.getIngredients().get(current.getIngredients().size() - 1).setAmount(Integer.parseInt(data));
